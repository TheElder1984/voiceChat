...
# Local TTS via RHVoice (Dragana)
def speak(text):
    try:
        # RHVoice supports Serbian Latin and Cyrillic
        subprocess.run(["RHVoice-test", "-p", "kristina"], input=text.encode("utf-8"))
...
# Setup GUI
root = tk.Tk()
root.title("Glasovni Asistent - YugoGPT-Florida + RHVoice")
